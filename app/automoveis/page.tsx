...
export default function AutomoveisPage() {
  return (
    <>
      <PageHeader
        badge="Seguro Auto"
        title="Seguro Automotivo que te acompanha"
        subtitle="Proteja seu veículo com coberturas personalizadas e assistência 24h. Escolha o seguro ideal para você e viaje com tranquilidade."
      />
