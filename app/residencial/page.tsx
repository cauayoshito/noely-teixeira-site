...
export default function ResidencialPage() {
  return (
    <>
      <PageHeader
        badge="Seguro Residencial"
        title="Seguro Residencial para sua casa"
        subtitle="Cuide do seu lar com cobertura contra imprevistos e assistência para pequenos reparos. Viva com tranquilidade."
      />
